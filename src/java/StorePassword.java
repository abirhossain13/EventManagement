...
import java.sql.*;
public class StorePassword extends HttpServlet{
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        response.setContentType("text/html");
        
        PrintWriter out=response.getWriter();
        //Fetching data from Psignup.html from user
        String up = request.getParameter("Participantusername");
        String pp = request.getParameter("Participantpassword");
        ...
        if(a2.equals(a3)){
            //Connection & storing into Database
             try{
                 ...
                 String pass = "12"; //Password for system
                 // Create connection
                 ...
                 RequestDispatcher rd=request.getRequestDispatcher("participentLogin.html");
